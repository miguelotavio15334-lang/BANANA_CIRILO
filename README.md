...
Tabs.LGa:AddButton({
    Title = 'Rain Fruit',
    Callback = function()
        local v293 = game:GetObjects('rbxassetid://108245351506282')[1]:GetChildren()
                    ...
                    if v1228.Name == 'Cursed Skeleton Boss' and (v1228:FindFirstChild('Humanoid') and (v1228:FindFirstChild('HumanoidRootPart') and v1228.Humanoid.Health > 0)) then
                        ...
                        elseif not u1223 then
                            game.StarterGui:SetCore('SendNotification', {
                                ...
                                con = 'rbxassetid://108245351506282',
                                Duration = 10,
                            })
...
game.StarterGui:SetCore('SendNotification', {
    ...
    Icon = 'rbxassetid://108245351506282',
    Duration = 100000,
    Button1 = 'Yes',
    Button2 = 'No',
})
...
Image.Image = "rbxassetid://108245351506282"
